...
export default function PageHelp({ leaving, onLeave, ...props }) {
  return (
    <Fadeable leaving={leaving} onLeave={onLeave}>
      <SetTitle {...props} title="How to use Flagbit Technology Radar" />
      <HeroHeadline>How to use Flagbit Technology Radar</HeroHeadline>
      <div className="fullpage-content">
        <h3>Introduction</h3>
        <p>Technology is moving fast and new technologies and innovations appear continuously.</p>
        <p>It's essential for a development and technology company such as Flagbit to constantly improve and keep track with the latest useful innovations.
        ...
        <h3>What is the Flagbit Tech Radar</h3>
        ...
        <p>We also hope that developers outside of Flagbit find the informations in our technologie overview inspirational.</p>
      ...
      <p>We also maintain a short list of useful tools - that are not worth putting on the radar - but that can belong in everyone's "toolbox". We call the list of these technologies the Flagbit Toolbox and you can find information about them here: <a href="toolbox.html">Flagbit Toolbox</a></p>
      <p>Contributions and source code of the radar are on github: <a href="https://github.com/flagbit/flagbit-technology-radar" target="_blank">Flagbit Tech Radar on GitHub</a></p>
